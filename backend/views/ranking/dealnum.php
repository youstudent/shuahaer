 ...
 */
$this->title = Yii::t('app','ranking_dealnum').'-'.Yii::$app->params['appName'];
...
<!--                                多货币修改-->
                                ...
                                <td class="text-center">
                                    <a href="<?=\yii\helpers\Url::to(['ranking/add-num','id'=>$value['id']])?>" class="btn btn-xs btn-success" data-toggle="modal" data-target="#myModal">&nbsp;添加次数&nbsp;&nbsp;</a>
                                </td>
