...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?=Yii::t('app','user_deduct_modal_title')?></h4>
        </div>
...
<!--                升级版本的多货币改动-->
                ...
                <?php echo $form->field($model,'pay_gold_num')->textInput([])->label('扣除金额')?>
        ...
        <div class="modal-footer">
            ...
            <button type="button" id="payModalSubmit" class="btn btn-primary"><?=Yii::t('app','but_submit_deduct')?></button>
        </div>
    </div>
</div>
<style>
