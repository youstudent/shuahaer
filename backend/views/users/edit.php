    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'agency_code')->textInput()?>
            <?php \yii\bootstrap\ActiveForm::end()?>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times">&nbsp;</i><?=Yii::t('app','but_close')?></button>
            <button type="button" id="payModalSubmit" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;<?=Yii::t('app','确认分配')?></button>
        </div>
    </div>
</div>
<style>
