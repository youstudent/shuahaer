 ...
 */
$this->title = Yii::t('app', 'rebate_index_ratio') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <tr>
                                ...
                                <th class="text-center">一级加盟商返利比</th>
                                <th class="text-center">二级加盟商返利比</th>
                                <th class="text-center">一级玩家返利比</th>
                            ...
                            <?php $i = 1; ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $data['agency_one'] ?>%</td>
                                    <td class="text-center"><?= $data['agency_two'] ?>%</td>
                                    <td class="text-center"><?= $data['users_one'] ?>%</td>
                                    <td class="text-center" style="width: 120px;">
                                        <a href="<?php echo \yii\helpers\Url::to(['rebate/ratio', 'id' => $data['id']]) ?>"
